...
int main(void) {
  ...
  lt_print(2, 2, LT_GREEN, LT_DEFAULT,
           "UTF-8: \xE2\x82\xAC \xC3\xA9 \xF0\x9F\x98\x80");
  lt_printf(2, 3, LT_YELLOW, LT_DEFAULT, "lt_printf: %d + %d = %d", 2, 40, 42);
  lt_print(2, 5, LT_CYAN, LT_DEFAULT,
           "multi-line:\n  second line\n  third line");
  /* Wide characters take two columns each; the box should line up. */
  lt_print(2, 8, LT_MAGENTA, LT_DEFAULT,
           "wide: \xE4\xBD\xA0\xE5\xA5\xBD (CJK = 2 cols)");
